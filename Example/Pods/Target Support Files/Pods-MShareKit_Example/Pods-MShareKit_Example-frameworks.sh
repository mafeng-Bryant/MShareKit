...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MPopUpAlertManager/MPopUpAlertManager.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MShareKit/MShareKit.framework"
